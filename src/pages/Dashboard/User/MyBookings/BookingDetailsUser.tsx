...
import { useGetAllBookingsByUserQuery } from "../../../../redux/features/bookings/bookingsApi";
...
const BookingDetailsUser = () => {
    ...
    const { data: allBookings } = useGetAllBookingsByUserQuery(undefined, { skip: !bookingId });
